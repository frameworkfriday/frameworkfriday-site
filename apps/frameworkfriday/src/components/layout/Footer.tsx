      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 sm:gap-8">
          ...
          <div className="col-span-2 md:col-span-1">
            <Image src={logo} alt="Framework Friday" className="h-8 w-auto brightness-0 invert mb-4" height={32} />
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li className="text-sm text-gray-500">hello@frameworkfriday.ai</li>
            </ul>
        ...
        <div className="border-t border-gray-800 mt-8 sm:mt-12 pt-6 sm:pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500">
            &copy; {new Date().getFullYear()} Framework Friday. All rights reserved.
          </p>
          <p className="text-xs text-gray-600 text-center md:text-right max-w-md">
            Friday Ventures evaluates partnerships independently. Framework Friday provides education only.
          </p>
        </div>
      </div>
    </footer>
