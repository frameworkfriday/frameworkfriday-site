          ...
          <div className="grid md:grid-cols-3 gap-12 md:gap-16">
            {[
              ...
              },
              {
                ...
                description:
                  "Across real teams, real workflows, real constraints.",
              },
              {
                step: "03",
                title: "We teach it",
                description:
                  "Only after it's proven do we share the playbook.",
              },
            ].map((item) => (
              <div key={item.step} className="text-center md:text-left">
                <span className="block text-6xl md:text-7xl font-bold text-primary leading-none">
                  {item.step}
                </span>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mt-8 sm:mt-12 bg-gray-950 text-white rounded-2xl p-6 sm:p-8 md:p-10 shadow-xl">
            ...
            <p className="text-sm text-gray-400 mt-1 uppercase tracking-wider font-medium">
              4-Day Diagnostic for Operators
            </p>
            <p className="text-gray-300 mt-3 sm:mt-4 max-w-xl leading-relaxed text-sm sm:text-base">
              Know exactly which workflow to automate first — and whether your
              team is ready. You'll produce a workflow inventory, automation map,
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="mt-5 sm:mt-6 inline-flex items-center justify-center gap-2 bg-primary text-white font-semibold px-6 py-3 rounded-lg hover:bg-primary-hover transition-colors w-full sm:w-auto"
            >
          ...
          <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 mt-6 sm:mt-8">
            ...
            <div className="card-hover bg-white border border-gray-200 rounded-2xl p-6 sm:p-8 flex flex-col">
              ...
              <p className="text-gray-500 mt-3 flex-1 leading-relaxed text-sm sm:text-base">
                Free foundational resources. Five self-paced lessons that
                prepare you for AI implementation. Each lesson produces an
                artifact.
              </p>
              <a
                href="https://start.frameworkfriday.ai/academy-home"
                target="_blank"
                rel="noopener noreferrer"
                className="mt-5 sm:mt-6 inline-flex items-center gap-1.5 text-gray-950 font-semibold hover:text-primary transition-colors"
              >
                Explore Academy
                <ArrowRight size={16} />
              </a>
            ...
            <div className="card-hover bg-primary text-white rounded-2xl p-6 sm:p-8 flex flex-col">
              ...
              <p className="text-white/80 mt-3 flex-1 leading-relaxed text-sm sm:text-base">
                For Decision Sprint graduates: ongoing peer accountability for
                operators actively building AI workflows.
              </p>
              <Link
                to="/forum"
                className="mt-5 sm:mt-6 inline-flex items-center gap-1.5 text-white font-semibold hover:underline"
              >
                Learn About Forum
                <ArrowRight size={16} />
              </Link>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-16 items-center">
            <div>
              <img
                src={lucasHeadshot}
                alt="Lucas Robinson"
                className="rounded-2xl w-full max-w-sm sm:max-w-md mx-auto shadow-lg"
              />
            </div>
            <div className="text-center md:text-left">
              ...
              <div className="space-y-4 text-gray-500 text-base sm:text-lg leading-relaxed">
                <p>
                  <strong className="text-gray-950">Lucas Robinson</strong> is
                  the CEO of Framework Friday and an operator across a portfolio
                  of companies generating $275M+ in revenue. He doesn't teach AI
                  theory — he deploys it inside real businesses every day.
                </p>
                <p>
                  Lucas also serves as AI Chair for Entrepreneurs' Organization —
                  to our knowledge, the first dedicated AI Chair in EO.
                </p>
                <p>
                  Everything in the Decision Sprint, Academy, and Forum comes
                  from what's actually working inside the portfolio — not what's
                  trending on social media.
                </p>
              </div>
              <Link
                to="/about"
                className="mt-6 sm:mt-8 inline-flex items-center gap-2 text-primary font-semibold hover:underline"
              >
                Meet the team
                <ArrowRight size={16} />
              </Link>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-3 gap-4 sm:gap-6 text-center">
            {[
              ...
              <div key={item.label}>
                <div className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-950">
                  {item.stat}
                </div>
      ...
      <section className="cta-section-gradient py-12 sm:py-20 md:py-24 px-4 text-white">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="mt-3 sm:mt-4 text-gray-400 text-base sm:text-lg">
            The Decision Sprint gives you a clear, prioritized implementation
            plan in 2 weeks.
          </p>
          <a
            href={START_URL}
            target="_blank"
            rel="noopener noreferrer"
            className="mt-6 sm:mt-8 inline-flex items-center justify-center gap-2 bg-primary text-white font-semibold px-8 py-3.5 sm:py-4 rounded-lg hover:bg-primary-hover transition-all text-base shadow-lg hover:shadow-xl w-full sm:w-auto"
          >
            Start Decision Sprint
            <ArrowRight size={18} />
          </a>
